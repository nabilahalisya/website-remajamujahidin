...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-5">
            <form method="POST" action="/insertmuda">
                <h4 class="text-center">Buat Akun <br> Anggota Muda</h4>
                <p class="text-center">Silahkan isi data di bawah ini!</p>
                        @csrf

                        <div class="form-group row">
                            <div class="row justify-content-center">
                                <label for="email" class="col-md-6 col-form-label text-md-right mb-1">Username</label>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        <select name="username" id="username" class="form-select form-control @error('username') is-invalid @enderror">
                        ...
                        <div class="form-group row mb-0">
                            <div class="row justify-content-center">
                                <div class="col-md-9 offset-md-3 mt-3">
                                    ...
                                    <a type="button" href="/buatakun/{id}" class="btn btn-primary">
                                        Cancel
                                    </a>
